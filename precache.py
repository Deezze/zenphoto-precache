...
print('Will create ' + str(len(cachefiles) - refresh_cached) + ' new caches and refresh ' + str(refresh_cached) + ' existing caches (' + str(already_cached) + ' already cached) for ' + str(image_files) + ' images (' + str(non_image_files) + ' non-image files skipped)...')
if(not args.pretend):
